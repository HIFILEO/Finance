...
public class ApplicationModule {
    ...
    public ApplicationModule(FinanceApplication application) {
    ...
    @Provides
    @Singleton
    public ScreenInfoServiceApi provideInfoServiceApi(Retrofit.Builder retrofit) {
        return retrofit.baseUrl("https://api.myjson.com/").build().create(ScreenInfoServiceApi.class);
    }
